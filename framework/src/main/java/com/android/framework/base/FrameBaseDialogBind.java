 ...
 * @date 2020/10/19
 */
public abstract class FrameBaseDialogBind<DB extends ViewDataBinding> extends FrameBaseDialog {
    protected DB binding;

    public FrameBaseDialogBind() {

    }

    public FrameBaseDialogBind(int contentLayoutId) {
